...
export default function EntryPage() {
  ...
  const handleEnter = () => {
    ...
    setOpening(true)
    // flap opens in 0.8s, then content fades in, navigate after 1.8s total
    setTimeout(() => setOpened(true), 800)
    setTimeout(() => navigate('/intro'), 1800)
  }
  ...
  return (
    <div className="entry-page">
      ...
      {/* ── Envelope ── */}
      <div className={`envelope-wrap ${opening ? 'opening' : ''} ${opened ? 'opened' : ''}`}>

        {/* Back of envelope */}
        <div className="envelope-back">
          <div className="envelope-back-diamond" />
        </div>

        {/* Flap (top triangle that folds open) */}
        <div className="envelope-flap">
          <div className="envelope-flap-inner" />
        </div>

        {/* Envelope body — the card slides up out of it */}
        <div className="envelope-body">
          <div className="envelope-body-left" />
          <div className="envelope-body-right" />
          <div className="envelope-body-bottom" />
        </div>
        ...
        <div className="envelope-card">
          <div className="entry-border-frame">
            ...
            <button className="entry-btn serif" onClick={handleEnter}>
              {opening ? (lang === 'zh' ? '正在进入…' : 'Opening…') : s.entryBtn}
            </button>
